...
import { selectors as skinsSelectors } from '../../slices/itemsSlice';
...
const Home = () => {
  ...
  const allSkins: Skin[] = useSelector(skinsSelectors.selectAll);
  ...
  }, [checkedFilters, allSkins, memoizedFilteredSkins]);
